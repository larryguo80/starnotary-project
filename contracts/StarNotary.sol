...
contract StarNotary is ERC721Full {
    ...
    // constructor() ERC721Full("StarNotary Token", "SNT") public { }
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        require(bytes(star.name).length > 0, "There is no star corresponding to this ID");
        return star.name;
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require (msg.sender == owner1 || msg.sender == owner2, "You should be the owner of star to be exchanged");
